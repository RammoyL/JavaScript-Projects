...
const Calculator = {
    ...
    //This will hold the operator, we set tit to null for now
    operator: null,
};
...
function Handle_Operator(Next_Operator) {
    ...
    //When an operator key is pressed we convert the current number displayed on the screen to a number and then
    ...
    if (First_Operand == null) {
        ...
        //If operator exists, property lookup is performed for the operator in the Perform_Calculaton object and the function
