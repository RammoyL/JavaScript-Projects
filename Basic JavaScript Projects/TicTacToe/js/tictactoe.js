...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //squareNumber and activePlater are concatenated together and added to array.
        selectedSquares.push(squareNumber + activePlayer);
        //This calls a function to check for any win conditions.
        checkWinConditions();
        //This condition is for change the active player.
        if (activePlayer === 'X') {
            //If active player is 'X' change it to 'O'.
            activePlayer = 'O';
            //if active plater is another other than 'X'
        } else {
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variable we pass are all included in our arry then true is returned and
        //our else if condition executes the drawLine() function.
...
//This function utilizes HTML canvas to drawl win lines.
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //This condition is similar to the one above but is necessary for 6, 4, 2 win conditions
...
//This fucntion resets the game in the event of a tie or a win.
function resetGame() {
    //This for loop iterates thtough each HTML square element
    for (let i = 0; i < 9; i++) {
    ...
    //This resets our arry so it is empty and we can start over
    selectedSquares = [];
}